...
v0.4.0 Full 已采用 392 同帧 liquid 完整配置，剩余设备验收仍按指南逐项追踪。旧路线比较与旧构建说明已转入[归档索引](archive/README.md)，有日期的实测数据保持原路径。

## 历史与实测资料

| 资料 | 内容与用途 |
| --- | --- |
| [Android 手柄接入调研](archive/2026-09-20-android-gamepad-research.md) | 系统输入 API 与实施前选型依据；现行适配见使用指南，手柄真机验收待完成 |
...
| [2026-09-16 遥控封面背景](performance/2026-09-16-focus-background/README.md) | Android 外接 WebView 缺失焦点事件的复现、补发通知与真机验证范围 |
