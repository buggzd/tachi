...
正在验证的实现见[24 Hz 采样诊断与液化邻域复用](performance/2026-09-15-liquid-24hz/README.md)：共享 tile 保持原公式，液化采样按已知媒体 PTS 选帧；同素材手机短测 16.34→19.96→21.21 Hz，尚未达到 24 Hz，不能代替外接显示长测。
